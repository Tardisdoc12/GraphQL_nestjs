...
const planets_resolver_1 = require("./planets.resolver");
...
exports.PlanetsModule = PlanetsModule = __decorate([
    (0, common_1.Module)({
        ...
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: planet_model_1.Planet.name, schema: planet_schema_1.PlanetSchema }]),
            (0, common_1.forwardRef)(() => satellites_module_1.SatellitesModule)
        ],
        providers: [planets_service_1.PlanetsService, planets_resolver_1.PlanetsResolver],
    })
], PlanetsModule);
