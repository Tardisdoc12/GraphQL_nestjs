...
class QueryPlanningTraversal {
    constructor(parameters, selectionSet, startFetchIdGen, hasDefers, rootKind, costFunction, initialContext, excludedDestinations = [], excludedConditions = []) {
        ...
        const initialOptions = (0, query_graphs_1.createInitialOptions)(initialPath, initialContext, this.conditionResolver, excludedDestinations, excludedConditions);
...
class FetchGroup {
    constructor(dependencyGraph, index, subgraphName, rootKind, parentType, isEntityFetch, _selection, _inputs, mergeAt, deferRef, subgraphAndMergeAtKey, cachedCost, isKnownUseful = false, inputRewrites = []) {
    ...
    cloneShallow(newDependencyGraph) {
        var _a;
        return new FetchGroup(newDependencyGraph, this.index, this.subgraphName, this.rootKind, this.parentType, this.isEntityFetch, this._selection.clone(), (_a = this._inputs) === null || _a === void 0 ? void 0 : _a.clone(), this.mergeAt, this.deferRef, this.subgraphAndMergeAtKey, this.cachedCost, this.isKnownUseful, [...this.inputRewrites]);
    }
    cost() {
        if (!this.cachedCost) {
